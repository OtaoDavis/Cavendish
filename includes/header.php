...
<body class="bg-gray-50">
  ...
  <div id="aeh-loader" class="aeh-loader-overlay">
    <div class="loader-content">
      <img src="images/logo.png" alt="Cavendish Africa" class="loader-logo-pulse" />
    </div>
  </div>
  ...
  <nav class="sticky-nav">
    <div class="nav-container">
      <a href="index.php" class="logo">
        <img src="images/logo.png" alt="Africa Education Holdings" class="logo-img" />
      </a>
      ...
      <div class="nav-links">
        ...
        <a href="cabs.php#enroll" class="nav-btn">Enroll</a>
      </div>
    </div>
  </nav>