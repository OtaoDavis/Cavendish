...
<!-- HERO -->
    <header class="team-editorial-hero">
      <div class="container">
        <div class="editorial-intro-grid">
          <div class="editorial-main">
            <h1>
              Cavendish is led by a dedicated team with a combined 100 years of
              experience in tertiary education across the United States and
              Africa.
            </h1>
          </div>
          <div class="editorial-narrative">
            ...
            <p>
              The Cavendish team is pioneering a different approach to education
              shaped by more than a decade of building and growing leading
              universities in Zambia and Uganda. Having navigated complex
              academic, regulatory, financial, and operational challenges, they
              remain driven by a shared belief: that transformative education
              and opportunity can empower young people and entrepreneurs to
              realize their full potential and unlock Africa's potential.
            </p>
          </div>
        </div>
      </div>
