    ...
    <section class="hero-split" id="heroSection">
      ...
      <div class="hero-text-box">
        ...
        <div class="hero-actions">
          ...
          <a href="programmes.php" class="pillar-link"
            >View Programmes <i class="fa-solid fa-arrow-right"></i
          ></a>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="pillar-row">
          <div class="p-content">
            ...
            <a href="purpose.php#identity" class="pillar-link"
              >Explore our Philosophy <i class="fa-solid fa-arrow-right"></i
            ></a>
          </div>
          <div class="p-image-column">
            <div class="image-offset-wrapper">
              ...
              <img
                src="images/edu.jpg"
                alt="Making High-Quality Education Accessible"
                loading="lazy"
              />
            </div>
          </div>
        ...
        <div class="pillar-row reverse">
          <div class="p-content">
            ...
            <a href="purpose.php#problem-centered" class="pillar-link"
              >See our Methodology <i class="fa-solid fa-arrow-right"></i
            ></a>
          </div>
          <div class="p-image-column">
            <div class="image-offset-wrapper">
              ...
              <img
                ...
                alt="Education Connected to Africa's Real Challenges"
                loading="lazy"
              />
            </div>
          </div>
        ...
        <div class="pillar-row">
          <div class="p-content">
            ...
            <a href="purpose.php#holistic" class="pillar-link"
              >See our Approach <i class="fa-solid fa-arrow-right"></i
            ></a>
          </div>
          <div class="p-image-column">
            <div class="image-offset-wrapper">
              ...
              <img
                src="images/pic1.jpg"
                alt="Educating the Whole Person"
                loading="lazy"
              />
            </div>
          </div>
            ...
            <div class="network-asset-grid">
              ...
              <div class="asset-details">
                <div class="details-inner">
                  ...
                  <a
                    href="https://www.cavendish.ac.ug/admissions/admission-requirements/"
                    class="btn-text-reveal"
                    target="_blank"
        ...
        <div class="impact-grid">
          ...
          <div class="impact-visual">
            <div class="visual-wrapper">
              ...
              <img
                src="images/potential2.JPG"
                alt="Cavendish Africa Students in the Field"
                class="impact-img"
                loading="lazy"
              />
    ...
    <section class="aeh-news-room section-white">
      <div class="container">
        ...
        <div class="news-header">
          ...
          <a href="news.php" class="btn-outline-news"
            >Visit Cavendish Africa Newsroom</a
          >
        </div>
